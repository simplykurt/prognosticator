...
/**
 * Defines an interface for querying Hive
 *
...
public interface HiveQuery {
     ...
     * Run a query.
     *
     * @param queryStatement the HiveQL to run
     * @param parameters a Map of parameters. Can be null.
     * @return a cursor to retrieve results
     */
